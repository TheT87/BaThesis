...
Um den Nachteil den die Verwendung von Signaturen mit sich bringt auszugleichen verwende ich osquery. osquery bietet die Möglichkeit eine Vielzahl an Informationen über die im Netzwerk befindlichen Systeme zu akquirieren. Dies ermöglicht beispielsweise mir die schon vorhanden Signaturen so zu verbessern das sie eine größere Menge von Ereignissen abdecken oder bereits definierte Ereignisse genauer zu spezifizieren und so weniger falsche Meldungen zu generieren.
\pagebreak
