...
\subsection{Entscheidung für ein IDS}Milenkoski et al. \cite{milenkoski_evaluating_2015}, wie in Tabelle \ref{Tabelle_1} zu sehen, kategorisieren IDS anhand der überwachten Plattform der verwendeten Erkennungsmethode und der Struktur, in der sie eingesetzt werden.
\begin{table}[H]
\label{Tabelle_1}
