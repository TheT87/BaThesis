...
\end{enumerate}
\lstset{escapeinside={(*@}{@*)}}
\begin{lstlisting}[consecutivenumbers=false,caption={Generierung einer Log-Datei mit Verbindungsinformationen}]
export {
...
\lstset{escapeinside={(*@}{@*)}}
\begin{lstlisting}[consecutivenumbers=false,caption={Geolocation und Setzen des Grenzwertes},firstnumber=31,linerange={31-37,42-54}]
module GeoLogTest;
